<?php
/**
 * Script pour générer les icônes PWA (192x192 et 512x512) depuis image/sugar_paper.jpg
 * À exécuter si vous modifiez le logo : php generate_pwa_icons.php
 */

$source = __DIR__ . '/image/sugar_paper.jpg';
$iconsDir = __DIR__ . '/icons';

if (!file_exists($source)) {
    die("Erreur : image/sugar_paper.jpg introuvable.\n");
}
