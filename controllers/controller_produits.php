...
function process_delete_produit($produit_id) {
    ...
    delete_produit_fichiers_upload($produit);
    ...
    return [
        'success' => false,
        'message' => 'Impossible de supprimer ce produit. Vérifiez les droits base de données ou contactez l’administrateur. Si le problème persiste : php migrations/run_fix_fk_suppression_produit.php'
    ];
}
