...
<head>
    ...
    <style>
        ...
        .gallery-nav {
            ...
            height: 40px;
            border-radius: 50%;
            border: 2px solid rgba(194, 102, 56, 0.4);
        ...
        .gallery-thumbs-list::-webkit-scrollbar-thumb {
            background: rgba(194, 102, 56, 0.4);
            border-radius: 4px;
        }
        ...
        .gallery-thumb.active {
            border-color: var(--couleur-dominante);
            box-shadow: 0 0 0 2px rgba(194, 102, 56, 0.3);
        }
        ...
        .produit-image-main {
            ...
            box-shadow: 0 8px 24px rgba(194, 102, 56, 0.1);
        }
        ...
        .option-select {
            padding: 10px 14px;
            border: 2px solid rgba(194, 102, 56, 0.3);
            border-radius: 8px;
            font-size: 14px;
            min-width: 140px;
            background: #fff;
        ...
        .produit-description {
            ...
            border: 1px solid rgba(194, 102, 56, 0.12);
            border-left: 4px solid var(--couleur-dominante);
        }
        ...
        .prix-total-section {
            padding: 18px;
            background: rgba(194, 102, 56, 0.85);
            color: #ffffff;
            border-radius: 12px;
            margin-bottom: 20px;
        ...
        .btn-add-panier:hover {
            ...
            box-shadow: 0 6px 20px rgba(194, 102, 56, 0.4);
        }
        ...
        .variante-option.selected {
            border-color: var(--couleur-dominante);
            background: rgba(194, 102, 56, 0.05);
        }
