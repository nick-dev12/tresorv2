...
<body>
    ...
    <section class="content-section">
        <?php if (isset($error_message)): ?>
            <div style="background: #fee; border-left: 4px solid #918a44; color: #6b2f20; padding: 12px 15px; border-radius: 6px; margin-bottom: 20px; font-size: 14px;">
        ...
        <div style="text-align: center; padding: 20px;">
            ...
            <div style="background: #fee; border: 2px solid #918a44; border-radius: 8px; padding: 20px; margin-bottom: 30px;">
                <i class="fas fa-exclamation-triangle" style="font-size: 48px; color: #918a44; margin-bottom: 15px;"></i>
