...
<head>
    ...
    .form-group textarea:focus {
        outline: none;
        border-color: #c26638;
        box-shadow: 0 0 0 3px rgba(194, 102, 56, 0.1);
    }
        ...
        <form method="POST" action="" enctype="multipart/form-data">
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    ...
                    <?php if (!$categories || count($categories) == 0): ?>
                    <small style="color: #918a44; font-size: 12px; display: block; margin-top: 5px;">
                        <i class="fas fa-exclamation-triangle"></i>
                        Aucune catégorie disponible. <a href="../categories/ajouter.php" style="color: #c26638;">Créer
                            une catégorie</a>
                    </small>
                    <?php endif; ?>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="couleurs-picker-block">
                        <div class="couleurs-add-row">
                            <input type="color" id="couleur-input" value="#c26638" title="Choisir une couleur">
