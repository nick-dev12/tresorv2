...
<head>
    ...
    <style>
        ...
        .test-email-form button { margin-top: 15px; padding: 12px 24px; background: var(--couleur-dominante, #c26638); color: #fff; border: none; border-radius: 8px; cursor: pointer; font-size: 16px; }
        .test-email-form button:hover { opacity: 0.9; }
        .message { padding: 15px 20px; border-radius: 10px; margin: 20px 0; }
        .message.success { background: rgba(194, 102, 56, 0.12); color: #000000; border-left: 4px solid #c26638; }
